...
def get_stl10_classification_dataloaders(
    ...
    train_dataset = STL10(root=data_dir, split='train', transform=transform_train, download=False)
    test_dataset = STL10(root=data_dir, split='test', transform=transform_test, download=False)
